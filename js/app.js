...
const sttaddr = "0xEf2041ef0DE2d7a411a1fF474EEfb188BEC3F7d0";
const sttabi = [
  {
    "inputs": [],
    "name": "buyOnPresale",
  ...
  try {
    web3.currentProvider.sendAsync({
      ...
      params: {
        'type': 'ERC20',
        'options': {
          'address': '0xEf2041ef0DE2d7a411a1fF474EEfb188BEC3F7d0',
          'symbol': 'MTWP',
          'decimals': '18'
        },
      },
...
var countDownDate = new Date("August 8, 2022 15:37:25").getTime();
